...
1. Generates a realistic random Pakinstani user using your
   own knowledge of common Pakinstani names across regions:
   - Name: a realistic Pakinstani first + last name
   - Email: derived from the name with a random 2-3 digit
     number suffix (e.g. ans.rasheed1@gmail.com)
